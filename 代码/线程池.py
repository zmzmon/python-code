...
if __name__ == "__main__":
    ...
    begin_sleep = time()
    future = threadPool.submit(test, 0)
    future2 = threadPool.submit(test, 1)
    future3 = threadPool.submit(test, 2)
    future4 = threadPool.submit(test, 3)
    #  threadPool后面是方法和参数
...
# reference https://www.cnblogs.com/venvive/p/11601190.html
